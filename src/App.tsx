  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-300 via-gray-200 to-slate-400 flex items-center justify-center">
        <div className="animate-pulse text-gray-600" style={{ fontFamily: '"Raleway", sans-serif' }}>
          Loading...
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-300 via-gray-200 to-slate-400 relative overflow-hidden">
      ...
      <nav className="relative flex justify-end p-4">
        {user ? (
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => signOut()}
              className="flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium text-gray-300 hover:text-white transition-all duration-300"
              style={{
      ...
      <header className="relative flex flex-col items-center pb-6">
        ...
        <p
          className="text-gray-600 tracking-wide text-center px-4"
          style={{ fontFamily: '"Raleway", sans-serif' }}
        >
          The Code Journey through 500 Programming Terms
        </p>
      </header>
      ...
      <main className="relative flex flex-col items-center px-4 pb-12">
        <div className="mt-4 relative">
          ...
          />
          <video
            className="relative max-h-[55vh] w-auto rounded-lg"
            style={{
