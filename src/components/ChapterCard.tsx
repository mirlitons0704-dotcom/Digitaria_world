...
const categoryColors: Record<string, { bg: string; border: string; icon: string }> = {
  ...
  files: { bg: 'from-amber-50 to-amber-100', border: 'border-amber-200', icon: 'text-amber-500' },
  data: { bg: 'from-emerald-50 to-emerald-100', border: 'border-emerald-200', icon: 'text-emerald-500' },
  programming: { bg: 'from-rose-50 to-rose-100', border: 'border-rose-200', icon: 'text-rose-500' },
  html: { bg: 'from-orange-50 to-orange-100', border: 'border-orange-200', icon: 'text-orange-500' },
  web: { bg: 'from-blue-50 to-blue-100', border: 'border-blue-200', icon: 'text-blue-500' },
  ...
  ui: { bg: 'from-pink-50 to-pink-100', border: 'border-pink-200', icon: 'text-pink-500' },
  ux: { bg: 'from-fuchsia-50 to-fuchsia-100', border: 'border-fuchsia-200', icon: 'text-fuchsia-500' },
  tailwind: { bg: 'from-teal-50 to-teal-100', border: 'border-teal-200', icon: 'text-teal-500' },
  terminal: { bg: 'from-slate-100 to-slate-200', border: 'border-slate-300', icon: 'text-slate-600' },
  npm: { bg: 'from-red-50 to-red-100', border: 'border-red-200', icon: 'text-red-500' },
  git: { bg: 'from-orange-50 to-orange-100', border: 'border-orange-200', icon: 'text-orange-600' },
  backend: { bg: 'from-green-50 to-green-100', border: 'border-green-200', icon: 'text-green-600' },
