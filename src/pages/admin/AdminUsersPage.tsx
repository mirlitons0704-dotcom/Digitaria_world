...
import { Loader2, Search, ChevronUp, ChevronDown, Shield, ArrowUpDown } from 'lucide-react';
                ...
                {filteredAndSorted.length === 0 ? (
                  ...
                  filteredAndSorted.map((user) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <span className="text-sm text-gray-300">{user.total_butterflies}</span>
                      </td>
                      <td className="px-6 py-4">
                        <span className="text-sm text-gray-300">Ch. {user.current_chapter}</span>
                      </td>
                      <td className="px-6 py-4">
